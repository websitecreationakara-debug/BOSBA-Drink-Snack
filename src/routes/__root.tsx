...
const ORG_JSON_LD = {
  ...
  url: "https://bosbadrinksnack.com",
  logo: "https://bosbadrinksnack.com/logo.png",
...
// Meta (Facebook) Pixel — official base snippet, run inline from <head> so it
// installs `fbq`, inits this ID and fires the first PageView before hydration.
// Client-side navigations are re-tracked from RootComponent; e-commerce events
// (ViewContent, AddToCart, InitiateCheckout, Purchase) go through trackPixel()
// from @/lib/meta-pixel.
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Japanese drinks and snacks, delivered across Cambodia." },
      { name: "theme-color", content: "#a63a2a" },
